...
> **new Player**(`id`, `name`, `data`): [`Player`](README.md#player)
...
• **data**: [`Data`](namespaces/Player.md#data) = `...`
...
[classes/Player.ts:35](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L35)
...
[classes/Player.ts:34](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L34)
...
[classes/Player.ts:32](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L32)
...
[classes/Player.ts:33](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L33)

#### Methods

##### addItem()

> **addItem**(`item`, `amount`): [`Player`](README.md#player)
...
[classes/Player.ts:296](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L296)

##### addStatistic()

> **addStatistic**(`statName`, `amount`): [`Player`](README.md#player)
...
[classes/Player.ts:414](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L414)
...
[classes/Player.ts:438](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L438)

##### decreaseAttribute()

> **decreaseAttribute**(`name`, `amount`): [`Player`](README.md#player)
...
[classes/Player.ts:517](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L517)
...
[classes/Player.ts:182](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L182)

##### getAttribute()

> **getAttribute**(`name`): [`Attribute`](../Attribute.md#attribute)
...
[classes/Player.ts:483](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L483)

##### getAttributes()

> **getAttributes**(): [`Attribute`](../Attribute.md#attribute)[]
...
[classes/Player.ts:461](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L461)

##### getBackpack()

> **getBackpack**(): [`Backpack`](../Backpack.md#backpack)
...
[classes/Player.ts:266](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L266)

##### getBackpackContents()

> **getBackpackContents**(): [`BackpackItem`](../BackpackItem.md#backpackitem)[]
...
[classes/Player.ts:280](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L280)
...
[classes/Player.ts:252](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L252)

##### getLootboxes()

> **getLootboxes**(): [`Lootbox`](../Lootbox/README.md#lootbox)[]

Retrieves the lootboxes of the player.

###### Returns

[`Lootbox`](../Lootbox/README.md#lootbox)[]
...
[classes/Player.ts:347](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L347)

##### increaseAttribute()

> **increaseAttribute**(`name`, `amount`): [`Player`](README.md#player)
...
[classes/Player.ts:500](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L500)

##### increaseBalance()

> **increaseBalance**(`minAmount`, `maxAmount`): [`Player`](README.md#player)
...
[classes/Player.ts:72](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L72)

##### increaseXP()

> **increaseXP**(`minAmount`, `maxAmount`): [`Player`](README.md#player)
...
[classes/Player.ts:52](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L52)
...
[classes/Player.ts:160](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L160)

##### modifyBalance()

> **modifyBalance**(`amount`): [`Player`](README.md#player)
...
[classes/Player.ts:108](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L108)

##### modifyXp()

> **modifyXp**(`amount`): [`Player`](README.md#player)
...
[classes/Player.ts:91](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L91)
...
• **lootbox**: [`Lootbox`](../Lootbox/README.md#lootbox)
...
> **player**: [`Player`](README.md#player)
...
[classes/Player.ts:326](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L326)

##### payToUser()

> **payToUser**(`player`, `amount`): [`Player`](README.md#player)
...
[classes/Player.ts:235](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L235)

##### prestige()

> **prestige**(): [`Player`](README.md#player)
...
[classes/Player.ts:449](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L449)

##### removeBalance()

> **removeBalance**(`amount`): [`Player`](README.md#player)
...
[classes/Player.ts:363](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L363)

##### removeItem()

> **removeItem**(`item`, `amount`): [`Player`](README.md#player)
...
[classes/Player.ts:384](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L384)

##### save()

> **save**(): `Promise`\<`Josh`\<[`JSON`](namespaces/Player.md#json)\>\>

Saves the current state of the Player instance to the database.

###### Returns

`Promise`\<`Josh`\<[`JSON`](namespaces/Player.md#json)\>\>
...
[classes/Player.ts:593](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L593)

##### setAttribute()

> **setAttribute**(`name`, `value`): [`Player`](README.md#player)
...
[classes/Player.ts:534](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L534)
...
[classes/Player.ts:577](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L577)
...
[classes/Player.ts:124](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L124)
...
[classes/Player.ts:139](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L139)

##### fromJSON()

> `static` **fromJSON**(`object`): [`Player`](README.md#player)

Static method to create a new Player instance from a JSON object.

###### Parameters

• **object**: [`JSON`](namespaces/Player.md#json)
...
[classes/Player.ts:565](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L565)

##### get()

> `static` **get**(`id`, `client`): `Promise`\<[`Player`](README.md#player)\>
...
`Promise`\<[`Player`](README.md#player)\>
...
[classes/Player.ts:550](https://github.com/LightBlueGamer/Prestigious/blob/85a20b132e245a5deb00df242c82d7c6845a7ed4/src/lib/classes/Player.ts#L550)
